...
*Setup instructions for a Gitian build of Tilt using Docker.*
...
You'll also need to clone the `tilt` repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/tilt-project/tilt.git
cd tilt/contrib/gitian
```
...
* a fork of the [gitian-sigs](https://github.com/tilt-project/gitian-sigs/) repo on your GitHub account.
